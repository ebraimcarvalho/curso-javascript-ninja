(function() {
  ...
  */
  var nordeste = ['Piauí', 'Maranhão', 'Ceará', 'Rio Grande do Norte', 'Paraíba', 'Pernambuco', 'Alagoas', 'Sergipe', 'Bahia'];
  ...
  */
  ...
  var maisDe7 = brasil.every(function(item) {
    return item.length > 7;
  })
  maisDe7 ? console.log('Sim, todos os estados tem mais de 7 letras!') : console.log('Nem todos os estados tem mais de 7 letras!');
  ...
  */
  ...
  ceara ? console.log('Ceará está incluido!') : console.log('Ceará não foi incluído :(')
  /*
